...
```bash
python models/train_generation_template.py --model gemma3_12b --experiment exp1 --gpu 0
```

### Other experiments (Exp3, Exp4, Exp5)
```bash
python models/train_generation_template.py --model gemma3_12b --experiment exp3 --gpu 0
```
