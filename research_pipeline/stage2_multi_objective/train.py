...
Run from repo root:
  PYTHONPATH=. python research_pipeline/stage2_multi_objective/train.py \\
...
from research_pipeline.stage2_multi_objective.hard_negatives import get_negative_output
from research_pipeline.stage2_multi_objective.losses import (
...
def load_init_from_exp3(exp3_rel: str, base_name: str):
...
def main() -> None:
    ...
    if args.init_from == "exp3" and exp3_path:
        model = load_init_from_exp3(exp3_path, base)
    else:
    ...
    def run_epoch(epoch: int) -> float:
        ...
        for batch in tqdm(loader, desc=f"epoch {epoch}"):
            ...
            sub_rows = [train_rows[ri] for ri in row_indices]
            ...
            pos_t = ref_emb
            neg_t = neg_emb
            loss_tr = triplet_margin_loss(anchor, pos_t, neg_t, margin=margin)
