#!/usr/bin/env python3
"""
Stage 3: DPO alignment (TRL) with reference = merged M2 or adapter+M2 base.

Preferences JSONL lines: {"prompt": "User: ...\\nAssistant:", "chosen": " ...", "rejected": " ..."}

  PYTHONPATH=. python research_pipeline/stage3_dpo/train.py \\
