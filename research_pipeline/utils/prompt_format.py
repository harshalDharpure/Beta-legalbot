"""Single formatting contract across all stages (matches existing legal-bot SFT)."""

from __future__ import annotations


def format_dialogue_prompt(user_text: str, assistant_text: str | None = None) -> str:
    """User/Assistant template (same as models/train_generation_template.format_prompt)."""
    p = f"User: {user_text}\nAssistant:"
